...
$bank = pg_fetch_assoc(pg_query($conn, "SELECT * FROM bank_accounts WHERE user_id = $user_id LIMIT 1"));
$wallet = pg_fetch_assoc(pg_query($conn, "SELECT balance FROM wallets WHERE user_id = $user_id"));
?>
<!DOCTYPE html>
<html lang="th">
<head>
